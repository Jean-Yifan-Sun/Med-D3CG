...
# ============================================================
# EchoNet 无条件生成 Pipeline
# ============================================================
# 数据集特性: 96x96 单通道心脏图像
# ============================================================

# 配置参数
DATA_ROOT="/bask/projects/c/chenhp-data-gen/yifansun/project/Med-D3CG/data/echonet/images"
OUTPUT_DIR="./results/echonet_unconditional"
MODEL_NAME="D3CG_uncond_db4"
OUT_NAME="echonet_uncond_db4"
IMAGE_SIZE=112
FID_STATS="/bask/projects/c/chenhp-data-gen/yifansun/project/DCTdiff/data/scratch/U-ViT2/assets/fid_stats/echo.npz"
